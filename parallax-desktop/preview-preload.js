...
const START_CHANNEL = 'parallax-preview-annotation-start';
const CANCEL_CHANNEL = 'parallax-preview-annotation-cancel';
const CAPTURED_CHANNEL = 'parallax-preview-annotation-captured';
const HOST_MESSAGE = 'parallax-preview-annotation';
...
function startAnnotation(theme = {}) {
  ...
  host.setAttribute('data-parallax-preview-overlay', '');
  host.style.cssText =
  ...
  function pickFromPoint(x, y) {
    ...
    if (element === host || element.closest?.('[data-parallax-preview-overlay]')) return null;
    return element;
  }
