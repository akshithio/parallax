...
describe('workspace surfaces', () => {
  test('keeps the brand next to the native window controls', () => {
    ...
    const brand = screen.getByText('Wess')
  ...
  test('shows update progress and restarts into a downloaded release', async () => {
    ...
    expect(screen.getByText('Wess 1.2.3')).toBeInTheDocument()
    ...
    rerender(
      <SettingsModal
        ...
        updateStatus={{
          ...
          availableVersion: '1.3.0',
          progress: 100,
          message: 'Wess 1.3.0 is ready to install.',
        }}
        onInstallUpdate={onInstallUpdate}
      />,
    )
