  ...
  return (
    ...
    >
      <div
        ...
        aria-modal="true"
        aria-labelledby="wess-dialog-title"
        aria-describedby={description ? 'wess-dialog-description' : undefined}
        className="w-full max-w-sm rounded-2xl border border-border bg-card p-4 text-card-foreground shadow-2xl animate-pop-in"
      >
        <h2 id="wess-dialog-title" className="text-[14px] font-semibold leading-5 text-foreground">
          {title}
        </h2>
        {description && (
          <div
            id="wess-dialog-description"
