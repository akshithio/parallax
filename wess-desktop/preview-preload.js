...
const START_CHANNEL = 'wess-preview-annotation-start';
const CANCEL_CHANNEL = 'wess-preview-annotation-cancel';
const CAPTURED_CHANNEL = 'wess-preview-annotation-captured';
const HOST_MESSAGE = 'wess-preview-annotation';
...
function startAnnotation(theme = {}) {
  ...
  host.setAttribute('data-wess-preview-overlay', '');
  host.style.cssText =
  ...
  function pickFromPoint(x, y) {
    ...
    if (element === host || element.closest?.('[data-wess-preview-overlay]')) return null;
    return element;
  }
